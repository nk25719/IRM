...
def after_sales_dashboard_data(conn):
    ...
    return {
        ...
        "submodules": [
            ...
            {"name": "Quotations", "path": "/aftersales/quotations", "existing_route": "/aftersales/quotations", "description": "After-Sales customer request quotations, imported documents, reviewed line items, and quote exports."},
